...
require_once(dirname(__FILE__).'/classes/nostotagging-analytics.php');
...
class NostoTagging extends Module
{
	...
	public function install()
	{
		return parent::install()
			&& NostoTaggingAnalytics::trackEvent('module', 'install')
			&& $this->initConfig()
	...
	public function uninstall()
	{
		return parent::uninstall()
			&& NostoTaggingAnalytics::trackEvent('module', 'uninstall')
	...
	protected function createAccount()
	{
		if (!$this->hasAccountName())
		{
			...
			$response = json_decode($response->getResult());
